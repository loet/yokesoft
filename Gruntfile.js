    ...
    var taskConfig = {
        ...
        concat: {
            ...
            build_css: {
                src: [
                    '<%= vendor_files.css %>',
                    '<%= build_dir %>/assets/<%= pkg.name %>-<%= pkg.version %>-tmp.css'
                ],
        ...
        less: {
            build: {
                ...
                //    '<%= build_dir %>/assets/appfiles.css': '<%= app_files.less %>'
                //}
            },
            compile: {
                files: {
                    //we assue, that build runs before compile, so we compile the build css
...
//            }
    ...
    grunt.registerTask('cordova', ['clean:cordova_all', 'build', 'cordovacli', 'copy:prepare_cordova']);
